...
const SignUp = () => {
    ...
    const [firstname, setFnam] = useState(true)
    const [lastname, setLnam] = useState(true)
    ...
    <div className="flex flex-col items-start justify-center flex-[.7] bg-[#7A5DC7]  px-[60px]  phone:flex-[.4] tablet:flex-[.5] phone:x-auto tablet:x-auto  tablet:items-center phone:items-center gap-4 tablet:rounded-bl-[100px] phone:rounded-bl-[50px] tablet:rounded-br-[100px] phone:rounded-br-[50px]">
        <div>
        <h1 className="main-font text-[80px] text-white tablet:text-[80px] phone:text-[50px] text-center  "> ProTrackr</h1>
    ...
    >
      <Input className=' body-font w-[25vw] border-[#7A5DC7] border-2 tablet:w-[40vw] phone:w-[60vw] ' onChange={(e)=>{setFnam(e.target.value)}} />
    </Form.Item>
    <Form.Item
        className='body-font '
        label="Last Name"
    ...
    >
      <Input className=' body-font w-[25vw] border-[#7A5DC7] border-2 tablet:w-[40vw] phone:w-[60vw] ' onChange={(e)=>{setLnam(e.target.value)}}/>
    </Form.Item>
      ...
      >
        <Input className=' body-font border-[#7A5DC7] border-2 tablet:w-[40vw] phone:w-[60vw]' onChange={(e)=>{setPhone(e.target.value)}} />
      </Form.Item>
      <Form.Item
            className=''
            label="Email"
            ...
            >
                <Input className=' w-[25vw] body-font border-[#7A5DC7] border-2 tablet:w-[40vw] phone:w-[60vw]' onChange={(e)=>{setEmail(e.target.value)}}></Input>
            </Form.Item>
      <Form.Item
            className=''
            label="Password"
